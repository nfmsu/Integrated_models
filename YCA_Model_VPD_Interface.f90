...
! MODIFICATION Line truncated by JJ 11.4.2023        
        get_YCA_VPDFPHR = get_Growth_VPDFPHR(get_YCA_PHSV(), get_YCA_PHTV(),  this%WEATHER % TDEW,&
 this%WEATHER % TMIN, this%WEATHER % TAIRHR,hour)
    ...
    real function get_YCA_VPDFP(this,LAI)
        ...
        class (YCA_VPD_type), intent(in) :: this
        REAL LAI
! MODIFICATION by JJ 11.4.2024      Line truncated  
        get_YCA_VPDFP = get_Growth_VPDFP(get_YCA_DAP(), LAI, get_YCA_PHSV(),&
 get_YCA_PHTV(),  this%WEATHER, this%CONTROL, this%SOILPROP)
